...
sub R_Comparison{
  ...
  $R->send(q`barplot(Data$Intensity, names.arg=Data$Label,  col=grey.colors(length(Data$Label), start = 0.1, end = 0.6, gamma = 2.2, alpha = NULL),space=2, yaxp=c(0,100,5),yaxt="n",mgp=c(0,0.5,0.1),font=4, axis.lty=1)`);
